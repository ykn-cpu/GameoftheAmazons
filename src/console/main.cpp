                        ...
                        if (!inMap(nx, ny))break;
                            ...
                            for (int adir = 0; adir < 8; adir++) {
                                for (int astep = 1; astep < GRIDSIZE; astep++) {
                                    ...
                                    else if (gridInfo[ax][ay] != 0)break;
                                    if (legal(x, y, nx, ny, ax, ay,color))return false;
                                }
                            }
                        }
                    }
...
void loadGame(const string& filename) {
    ...
    fin.read((char*)&mycolor, sizeof(mycolor));           // 读回玩家颜色
    fin.close(); // 关闭文件
    cout << "游戏已读取！" << endl;
}
void humanMove() {
...
void aiMove() {
    ...
    if (!bestmoves.empty()) {
        ...
        cout << "AI move: " << m.x0 << " " << m.y0 << " " << m.x1 << " " << m.y1 << " " << m.x2 << " " << m.y2 << endl;
    }
}
void initBoard() {
